...
namespace ThemeParkResourceViewer
{
	public partial class MainForm : Form
	{
				...
				case "MUS|3":
					{
						...
						MusicPlayer.Play(soundBytes, loopSoundToolStripMenuItem.Checked);
					}
					break;
		...
		void DrawGrid()
		{
			...
			{
				var dest = SpriteViewer.GetSpriteCenter(tab.Width, tab.Height, SpriteViewer.TileSize, SpriteViewer.TileSize);
				int posX = index % tilesPerRow * SpriteViewer.TileSize + dest.X;
				int posY = index / tilesPerRow * SpriteViewer.TileSize + dest.Y;
			...
			void AnimateGrid()
			{
				...
				foreach (var anim in Package.Animations)
				{
					if (anim.Width > 0 && anim.Height > 0)
					{
						...
						{
							var dest = SpriteViewer.GetSpriteCenter(anim.Width, anim.Height, SpriteViewer.TileSize, SpriteViewer.TileSize);
							int posX = index % tilesPerRow * SpriteViewer.TileSize + dest.X;
							int posY = index / tilesPerRow * SpriteViewer.TileSize + dest.Y;
