...
namespace ThemeParkResourceViewer
{
	public partial class MainForm : Form
	{
		...
		{
			pictureBox.Visible = view == 0 || view == 1; //sprite or movie
			panelTrackBar.Visible = view == 1 || view == 2; //movie or music
			tableLayoutPanel1.Dock = view == 1 || view == 2 || view == 3 ? DockStyle.Fill : DockStyle.None; //movie, music or text
			textBox.Visible = view == 3; //text
		}
