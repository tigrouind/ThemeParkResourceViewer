...
Click on `File` > `Set game location folder...` and select folder where game is installed. If you create a folder named `DATA` and put it in same place as executable, it will automatically load files from there.
